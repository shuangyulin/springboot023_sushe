          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="住宿费用" prop="zhusufeiyong">
          <el-input v-model="ruleForm.zhusufeiyong" 
              placeholder="住宿费用" clearable  :readonly="ro.zhusufeiyong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="住宿费用" prop="zhusufeiyong">
              <el-input v-model="ruleForm.zhusufeiyong" 
                placeholder="住宿费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
            continue;
	            	            ...
	            	            if(o=='zhusufeiyong'){
            this.ruleForm.zhusufeiyong = obj[o];
	    this.ro.zhusufeiyong = true;
            continue;
          }
	            	            if(o=='fabushijian'){
